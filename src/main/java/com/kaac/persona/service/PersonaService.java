...
import com.kaac.persona.repository.IPersonaRepository;
...
public class PersonaService implements IPersonaRepository{
    ...
    public List<Persona> findAll() {
        return this.iPersonaRepository.findAll();
    }

    @Override
    public void delete(Persona entity) {
        this.iPersonaRepository.delete(entity);
    }

    @Override
    public void deleteById(Long aLong) {
        this.iPersonaRepository.deleteById(aLong);
    }

    @Override
    public <S extends Persona> S save(S entity) {
        return this.iPersonaRepository.save(entity);
    }
